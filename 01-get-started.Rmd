...
`renv` est plus récent que `Packrat` et est amené à le remplacer, il n'est pas encore intégré à Rstudio mais apporte des améliorations subsentielles par rapport à son prédécesseur. 
